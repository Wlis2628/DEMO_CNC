...
END_FUNCTION_BLOCK
 ...
 FUNCTION_BLOCK MTBasicsPWMSchedule (*Multiple pulse width modulator.*)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
		...
		DutyCycle :  UDINT; (*Address of an array of data type REAL with the duty cycles. Unit of the values of the array: [%]. Permitted range of values for the values of the assigned array: 0 <= DutyCycle[i] <= 100.*)
		ZonePower :  UDINT; (*Address of an array of data type REAL with the power of the zones. Unit of the values of the array: [kW]. Permitted range of values for the values of the assigned array: ZonePower[i] > 0.*)
	...
	VAR_OUTPUT
		...
		StatusID : DINT; (*Status information.*)
		UpdateDone : BOOL; (*Update is done.*)
		PulseWave :  UDINT; (*Address of an array of data type BOOL with the pulses.*)
		LimitedDutyCycle :  UDINT; (*Address of an array of data type REAL with the limited duty cycles. Unit of the values of the array: [%].*)
